#!/usr/bin/python
#
# Utility for extracting text and images from SIMPLE pdf documents.
#
# Requirements: pip install pdfminer (for Python 2+) and pip install pdfminer.six (for Python 3+)
# Main methods:
#   get_toc(): table of contents if available
#   get_pages(): get pages, images saved automatically to /tmp folder.
#
# Note: this works for simple documents, may break down when document contains tables.
# 
# original source: https://github.com/dpapathanasiou/pdfminer-layout-scanner
    ...
    for lt_obj in lt_objs:
        if isinstance(lt_obj, LTTextBox) or isinstance(lt_obj, LTTextLine):
            ...
            if saved_file:
                ...
                print(sys.stderr, "error saving image on page {} {}".format(page_number, lt_obj.__repr__))
